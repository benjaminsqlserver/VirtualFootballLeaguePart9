...
namespace VirtualLeague
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            oDataBuilder.EntitySet<VirtualLeague.Models.ConData.AspNetRole>("AspNetRoles");
            oDataBuilder.EntitySet<VirtualLeague.Models.ConData.AspNetRoleClaim>("AspNetRoleClaims");
            oDataBuilder.EntitySet<VirtualLeague.Models.ConData.AspNetUser>("AspNetUsers");
            oDataBuilder.EntitySet<VirtualLeague.Models.ConData.AspNetUserClaim>("AspNetUserClaims");

            var aspNetUserLogin = oDataBuilder.EntitySet<VirtualLeague.Models.ConData.AspNetUserLogin>("AspNetUserLogins");
            aspNetUserLogin.EntityType.HasKey(entity => new {
              entity.LoginProvider, entity.ProviderKey
            });

            var aspNetUserRole = oDataBuilder.EntitySet<VirtualLeague.Models.ConData.AspNetUserRole>("AspNetUserRoles");
            aspNetUserRole.EntityType.HasKey(entity => new {
              entity.UserId, entity.RoleId
            });

            var aspNetUserToken = oDataBuilder.EntitySet<VirtualLeague.Models.ConData.AspNetUserToken>("AspNetUserTokens");
            aspNetUserToken.EntityType.HasKey(entity => new {
              entity.UserId, entity.LoginProvider, entity.Name
            });
            oDataBuilder.EntitySet<VirtualLeague.Models.ConData.DeviceCode>("DeviceCodes");
            ...
            oDataBuilder.EntitySet<VirtualLeague.Models.ConData.Key>("Keys");
            ...
            oDataBuilder.EntitySet<VirtualLeague.Models.ConData.PersistedGrant>("PersistedGrants");
